...
public struct ResourceDownloadWrapper<Base> {
...
public protocol ResourceDownloadCompatibleValue {}

extension ResourceDownloadCompatibleValue {
    /// Gets a namespace holder for Kingfisher compatible types.
    public var rd: ResourceDownloadWrapper<Self> {
        get { return ResourceDownloadWrapper(self) }
        set { }
    }
}

extension String: ResourceDownloadCompatibleValue { }
extension ResourceDownloadWrapper where Base == String {
    var md5: String {
